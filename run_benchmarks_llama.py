...
# Synchronisations-Klasse für Llama (analog zu deiner App)
class LlamaRuntimeBridge:
    def __init__(self, base_model):
        # FIX: Nutzt jetzt die korrekt übergebene Variable 'base_model'
...
def run_production_benchmark():
    print("\n==================================================================")
    print("📊 AIR BENCHMARK HARNESS: META LLAMA 3.2 1B (Version 2.0)")
    print("==================================================================\n")

    # 1. Absolute Pfade definieren (analog zu deiner funktionierenden App)
    abs_storage_path = r"C:\Users\onuri\Desktop\nn-md\adaptive_onthefly_v02\shortcuts_llama.pt"

    # 2. Pipeline initialisieren
    print("[Harness] Lade Llama-Infrastruktur und Gewichte im RAM...")
    ...
    engine = ShortcutSynthesizer(base_llama, analyzer, convergence_threshold=0.80, storage_file=abs_storage_path)
    ...
    bridge = LlamaRuntimeBridge(base_llama)
    runtime = EvolutionaryInferenceEngine(bridge, engine, compiler, validator)

    # 3. Das heterogene Testkorpus (Deine 50 vordefinierten Sätze)
    test_corpus = [
    ...
    # Wir leeren die gelernten Strukturen temporär im RAM für den harten Baseline-Test
    ...
    # Wir holen das gelernte Wissen aus deiner funktionierenden shortcuts_llama.pt zurück ins System
    ...
    print("\n==================================================================")
    print("📊 AIR GLOBAL BENCHMARK EFFICIENCY REPORT")
    print("==================================================================")
